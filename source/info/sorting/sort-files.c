...
static inline int compare_inodes (const void *file_1, const void *file_2) {
	const ino_t ino_1 = ((const FileInfo *)file_1)->inode;
	const ino_t ino_2 = ((const FileInfo *)file_2)->inode;

	if (ino_1 < ino_2) return -1;
	if (ino_1 > ino_2) return  1;
	return 0;
}

static inline int compare_sizes (const void *file_1, const void *file_2) {
	return ((const FileInfo *)file_1)->size - ((const FileInfo *)file_2)->size;
}

static inline int compare_times (const void *file_1, const void *file_2) {
	return ((const FileInfo *)file_1)->time - ((const FileInfo *)file_2)->time;
}

static inline int compare_users (const void *file_1, const void *file_2) {
	return ((const FileInfo *)file_1)->uid   - ((const FileInfo *)file_2)->uid;
}

static inline int compare_groups(const void *file_1, const void *file_2) {
	return ((const FileInfo *)file_1)->gid   - ((const FileInfo *)file_2)->gid;
}
